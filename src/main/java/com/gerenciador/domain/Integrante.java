...
public class Integrante implements Serializable {
    ...
    public Integrante (Integer id, String nomeEquipe, String descricao) {
    }

    public Integrante(Integer id, String nome, Character cpf, String cargo, String tipoContratacao) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.cargo = cargo;
